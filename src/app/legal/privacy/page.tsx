...
import { LEGAL_VERSION, PRIVACY_MARKDOWN } from "@/lib/legal/creatrops-legal-content";
import { LegalProse } from "@/lib/legal/LegalProse";

export const metadata: Metadata = {
  title: "Privacy Policy | CreatrOps",
  description: "CreatrOps Privacy Policy",
};
  ...
  return (
    <div className="min-h-screen bg-[#050505] px-5 py-12 text-[#FAFAFA]">
      ...
      <div className="relative mx-auto max-w-3xl">
        ...
        <LegalProse markdown={PRIVACY_MARKDOWN} />
        ...
        <p className="mt-6 text-center text-sm text-[#8F8678]">
          <Link href="/legal/terms" className="text-[#C9A84C] underline-offset-2 hover:underline">
            Terms of Service
          </Link>
        </p>
